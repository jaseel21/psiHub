          ...
          <div className="banner">
            ...
            <div className='col-xs-12 col-sm-6 col-md-6  content'>
              <div className="">
                ...
                <button className="b-button"><svg style={{ marginLeft: "-1rem" }} xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
            ...
            <div  className=''>
              ...
              <img className="col-12 col-sm-12 col-md-6" src="../../../image/mandemo.png" alt="is Empty" />
            </div>
